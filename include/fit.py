    ...
    for i in range(num_iter):
        ...
        def closure():
            ...
            if i % 10 == 0:
                ...
                snr=psnr(out2.detach().cpu().numpy(), img_clean_var.detach().cpu().numpy())
                ...
                print ('Iteration %05d    Train loss %f  Actual loss %f PSNR %f ' % (i, loss.data,true_loss.data,snr), '\r', end='')
